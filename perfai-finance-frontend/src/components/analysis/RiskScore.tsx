  ...
  return (
    ...
    >
      ...
      {confidence !== undefined && (
        <p className="mt-5 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2 text-sm text-white/60">
          Confiance de l’analyse : <span className="font-semibold text-white">{confidence} %</span>
        </p>
      )}
    </div>
  );
